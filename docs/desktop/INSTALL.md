...
初回起動時に、使用する AI モデルのプロバイダを選択するよう促されます。

### 推奨設定

1. **OpenCode Zen** を選択 → ブラウザが開くのでアカウント作成と API キーの発行を行う
2. または **OpenAI / Anthropic** などのプロバイダを選択し、API キーを入力

API キーは、アプリ内の設定画面からいつでも変更できます。
